// Code generated by the Encore v1.34.8 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-uptime-gbx2.encr.app`
}
...
/**
 * Client is an API client for the uptime-gbx2 Encore application. 
 */
...
export namespace monitor {
    ...
    export class ServiceClient {
        ...
        public async Check(siteID: number): Promise<void> {
            await this.baseClient.callAPI("POST", `/checks/${encodeURIComponent(siteID)}`)
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "uptime-gbx2-Generated-TS-Client (Encore/v1.34.8)";
        }
